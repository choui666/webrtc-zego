...
var Common = /** @class */ (function () {
    ...
    Common.prototype.onPlayStateUpdateHandle = function (type, streamid, error) {
        ...
        this.onPublishStateUpdateCustomer(type, streamid, error);
    };
    ;
    //type: { start: 0, stop: 1}
...
var BaseCenter = /** @class */ (function (_super) {
   ...
   */
    ...
    BaseCenter.prototype.bindStreamHandler = function () {
        ...
        this.streamHandler.onStreamUpdated = function (type, streamList) {
            ...
            _this.onStreamUpdatedCustomer(type, streamList);
        };
   ...
   */
    ...
    */
    ...
    BaseCenter.prototype.onStreamUpdatedCustomer = function (type, streamList) {
    };
    ...
    BaseCenter.prototype.onPublishStateUpdateCustomer = function (type, streamid, error) {
    };
...
var ZegoClient = /** @class */ (function (_super) {
    ...
    */
    ...
    ZegoClient.supportVideoCodeType = function (sucCall, errCall) {
        client_util_1.ClientUtil.supportVideoCodeType(sucCall, errCall);
    };
    ...
    ZegoClient.prototype.startVideoTalk = function (_a) {
        var _this = this;
        var streamList = _a.streamList, previewConfig = _a.previewConfig, localVideo = _a.localVideo, remoteVide = _a.remoteVide, streamId = _a.streamId;
        var publishTryCount = 0;
        //座席端
        if (client_util_1.ClientUtil.IsPC() && client_util_1.ClientUtil.getBrowser() === 'Chrome') {
            this.startPreview(localVideo, previewConfig, function () {
                // 客户已经推流
                if (streamList && streamList.length > 0) {
                    var _a = streamList[0], stream_id = _a.stream_id, extra_info = _a.extra_info;
                    var videCodeType = JSON.parse(extra_info).videCodeType;
                    _this.startPlayingStream(stream_id, remoteVide, '', {
                        videoDecodeType: videCodeType
                    });
                    _this.startPublishingStream(streamId, localVideo, extra_info, {
                        videoDecodeType: videCodeType
                    });
                } // 等待客户推流
                _this.onStreamUpdatedCustomer = function (type, streamListAfter) {
                    if (type == 0) {
                        var _a = streamListAfter[0], stream_id = _a.stream_id, extra_info = _a.extra_info;
                        var videCodeType = JSON.parse(extra_info).videCodeType;
                        _this.startPlayingStream(stream_id, remoteVide, '', {
                            videoDecodeType: videCodeType
                        });
        ...
        else if (client_util_1.ClientUtil.getOS() === 1 && !client_util_1.ClientUtil.IsPC()) { // 安卓客户端
            // 直接推流
            client_util_1.ClientUtil.supportVideoCodeType(function (_a) {
                var H264 = _a.H264, VP8 = _a.VP8, Vp9 = _a.Vp9, H265 = _a.H265;
                _this.startPreview(localVideo, previewConfig, function () {
                    var videCodeType = VP8 ? 'VP8' : (H264 ? 'H264' : null);
                    if (videCodeType) {
                        var extraInfo = { videCodeType: videCodeType };
                        _this.startPublishingStream(streamId, localVideo, JSON.stringify(extraInfo), {
                            videoDecodeType: videCodeType
                        });
                    }
                    else {
                ...
                _this.onPublishStateUpdateCustomer = function (type, streamid, error) {
                    if (type === 1 && publishTryCount === 0) {
                        publishTryCount++;
                        var videCodeType = H264 ? 'H264' : (VP8 ? 'VP8' : null);
                        if (videCodeType) {
                            _this.stopPublishingStream(streamid);
                            var extraInfo = { videCodeType: videCodeType };
                            _this.startPublishingStream(streamId, localVideo, JSON.stringify(extraInfo), {
                                videoDecodeType: videCodeType
                            });
        ...
        else if (client_util_1.ClientUtil.getOS() === 2 && client_util_1.ClientUtil.getBrowser() === 'Safari') { // ios客户端
            // 直接推流
            // 直接推流
            client_util_1.ClientUtil.supportVideoCodeType(function (_a) {
                var H264 = _a.H264, VP8 = _a.VP8, Vp9 = _a.Vp9, H265 = _a.H265;
